...
[![JitPack](https://img.shields.io/badge/JitPack-ready-green.svg)](https://jitpack.io/#andrestubbe/FastTweenp)
...
1. 📦 **[fasttween-0.1.0.jar](https://github.com/andrestubbe/FastTween/releases/download/0.1.0/fasttween-0.1.0.jar)** (The Core Library)
2. 📦 **[fastcore-0.1.0.jar](https://github.com/andrestubbe/FastCore/releases/download/0.1.0/fastcore-0.1.0.jar)** (The Mandatory Native JNI Loader)
